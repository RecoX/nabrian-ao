...
Nombre.Caption = "Nombre: " & ReadFieldOptimizado(1, Rdata, 44)
Raza.Caption = "Raza: " & ReadFieldOptimizado(2, Rdata, 44)
Clase.Caption = "Clase: " & ReadFieldOptimizado(3, Rdata, 44)
Genero.Caption = "Genero: " & ReadFieldOptimizado(4, Rdata, 44)
Nivel.Caption = "Nivel: " & ReadFieldOptimizado(5, Rdata, 44)
Oro.Caption = "Oro: " & ReadFieldOptimizado(6, Rdata, 44)
Banco.Caption = "Banco: " & ReadFieldOptimizado(7, Rdata, 44)

If Val(ReadFieldOptimizado(8, Rdata, 44)) = 1 Then
    fundo.Caption = "Fundo el clan: " & ReadFieldOptimizado(9, Rdata, 44)
Else
    fundo.Caption = "Fundo el clan: Ninguno"
End If

Solicitudes.Caption = "Solicitudes para ingresar a clanes: " & ReadFieldOptimizado(10, Rdata, 44)
solicitudesRechazadas.Caption = "Solicitudes rechazadas: " & ReadFieldOptimizado(11, Rdata, 44)
lider.Caption = "Veces fue lider de clan: " & ReadFieldOptimizado(12, Rdata, 44)
integro.Caption = "Clanes que integro: " & ReadFieldOptimizado(13, Rdata, 44)

Select Case Val(ReadFieldOptimizado(14, Rdata, 44))
    Case 0
        faccion.ForeColor = vbWhite
        faccion.Caption = "Faccion: Neutral"
    Case 1
        faccion.ForeColor = vbBlue
        faccion.Caption = "Faccion: Alianza del Nabrian"
    Case 2
        faccion.ForeColor = vbRed
        faccion.Caption = "Faccion: Ejército de Lord Thek"
End Select

neutrales.Caption = "Neutrales asesinados: " & ReadFieldOptimizado(15, Rdata, 44)
Ciudadanos.Caption = "Ciudadanos asesinados: " & ReadFieldOptimizado(16, Rdata, 44)
criminales.Caption = "Criminales asesinados: " & ReadFieldOptimizado(17, Rdata, 44)
